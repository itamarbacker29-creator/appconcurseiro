...
const MATERIAS: { nome: string; icon: string }[] = [
  ...
  { nome: 'Direito Civil', icon: 'balance' },
  { nome: 'Direito do Trabalho', icon: 'work' },
  { nome: 'Direito Tributário', icon: 'receipt_long' },
  { nome: 'Português', icon: 'menu_book' },
  { nome: 'Língua Inglesa', icon: 'language' },
  { nome: 'Raciocínio Lógico', icon: 'lightbulb' },
  { nome: 'Matemática', icon: 'calculate' },
  { nome: 'Informática', icon: 'computer' },
  { nome: 'Administração', icon: 'business_center' },
  { nome: 'Contabilidade', icon: 'account_balance_wallet' },
  { nome: 'Economia', icon: 'trending_up' },
  { nome: 'Legislação Específica', icon: 'description' },
  { nome: 'Saúde Pública', icon: 'health_and_safety' },
  { nome: 'Epidemiologia', icon: 'biotech' },
  { nome: 'Enfermagem', icon: 'medical_services' },
  { nome: 'Farmácia', icon: 'medication' },
  { nome: 'Psicologia', icon: 'self_improvement' },
  { nome: 'Nutrição', icon: 'restaurant' },
  { nome: 'Odontologia', icon: 'dentistry' },
  { nome: 'Fisioterapia', icon: 'accessibility_new' },
  { nome: 'Serviço Social', icon: 'people' },
];
